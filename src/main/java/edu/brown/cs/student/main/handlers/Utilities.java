...
/**
 * The Utilities class provides utility methods for handling responses in the CSV loading and search
 * view.
 */
public class Utilities {
  ...
  public record SuccessResponse(String response_type, Map<String, Object> responseMap) {
    ...
    /**
     * Constructs a SuccessResponse with the provided response map and sets the response type to
     * "success".
     *
  ...
  public record FailureResponse(String response_type, String error_msg) {
    ...
    /**
     * Constructs a FailureResponse with the provided error message and sets the response type to
     * "Exception".
     *
